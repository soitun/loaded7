...
class Loaded7_SSO_Connector extends lC_Addon { // your addon must extend lC_Addon
  ...
  */
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Wordpress URL', 'ADDONS_CONNECTORS_" . strtoupper($this->_code) . "_REMOTE_APPLICATION_URL', '', '\"http://www.mywordepress.com\" for top level domain, \"http://wordepress.mystore.com\" for subdomains, \"http://www.mystore.com/wordepress/\" for a folder on a top level domain', '6', '0', now())");
